...
const content = {
  fr: {
    ...
    projects: [
      ...
      { name: 'A.SAP Consulting', description: 'Conseil & int̩gration SAP ERP', location: 'International', accent: '#3B82F6', accentDark: '#1D4ED8', tech: 'Next.js + Tailwind', type: 'corporate' },
