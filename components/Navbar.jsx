    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            <img src="/Sleek%20Monogram%20Logo%20'D1'%20Design.png" width={40} height={40} alt="Day1 Digital logo" className="w-10 h-10 rounded-lg group-hover:shadow-[0_0_20px_rgba(132,204,22,0.5)] transition-shadow duration-300" />
